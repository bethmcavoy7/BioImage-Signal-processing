...
ecg_wave=ecg_notch-g; % subtracting 10th level aproximation signalfrom original signal                  
ecg_smooth=smooth(ecg); % using average filter to remove glitches
...
title('POINCARE PLOT o'), xlabel('RR(n)') ,ylabel('RR(n+1)')
sd1=std(rr4);
sd2=std(rr5);
sdd=sd1/sd2;
